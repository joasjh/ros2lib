...
bool rosbag2_storage_mcap_testdata__msg__basic_idl__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosbag2_storage_mcap_testdata.msg._basic_idl.BasicIdl", full_classname_dest, 53) == 0);
  }
  rosbag2_storage_mcap_testdata__msg__BasicIdl * ros_message = _ros_message;
  {  // x
...
PyObject * rosbag2_storage_mcap_testdata__msg__basic_idl__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosbag2_storage_mcap_testdata.msg._basic_idl");
