...
bool rosbag2_storage_mcap_testdata__msg__complex_msg_depends_on_idl__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosbag2_storage_mcap_testdata.msg._complex_msg_depends_on_idl.ComplexMsgDependsOnIdl", full_classname_dest, 84) == 0);
  }
  rosbag2_storage_mcap_testdata__msg__ComplexMsgDependsOnIdl * ros_message = _ros_message;
  {  // a
...
PyObject * rosbag2_storage_mcap_testdata__msg__complex_msg_depends_on_idl__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosbag2_storage_mcap_testdata.msg._complex_msg_depends_on_idl");
