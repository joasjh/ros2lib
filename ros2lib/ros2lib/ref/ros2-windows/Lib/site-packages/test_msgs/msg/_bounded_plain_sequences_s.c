...
bool test_msgs__msg__bounded_plain_sequences__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.msg._bounded_plain_sequences.BoundedPlainSequences", full_classname_dest, 60) == 0);
  }
  test_msgs__msg__BoundedPlainSequences * ros_message = _ros_message;
  {  // bool_values
...
PyObject * test_msgs__msg__bounded_plain_sequences__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_msgs.msg._bounded_plain_sequences");
