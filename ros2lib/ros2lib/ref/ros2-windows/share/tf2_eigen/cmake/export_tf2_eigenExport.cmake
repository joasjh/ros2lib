...
foreach(_cmake_expected_target IN ITEMS tf2_eigen::tf2_eigen)
...
# Create imported target tf2_eigen::tf2_eigen
add_library(tf2_eigen::tf2_eigen INTERFACE IMPORTED)

set_target_properties(tf2_eigen::tf2_eigen PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/tf2_eigen;C:/ProgramData/chocolatey/lib/eigen/include"
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/export_tf2_eigenExport-*.cmake")
