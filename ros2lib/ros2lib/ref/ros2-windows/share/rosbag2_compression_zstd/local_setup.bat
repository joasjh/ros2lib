...
set "AMENT_ENVIRONMENT_HOOKS[rosbag2_compression_zstd]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_compression_zstd] "%AMENT_CURRENT_PREFIX%\share\rosbag2_compression_zstd\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_compression_zstd] "%AMENT_CURRENT_PREFIX%\share\rosbag2_compression_zstd\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosbag2_compression_zstd]:;=";"%") do (
    call:call_file %%f
  )
