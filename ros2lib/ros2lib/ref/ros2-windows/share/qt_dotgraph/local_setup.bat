...
set "AMENT_ENVIRONMENT_HOOKS[qt_dotgraph]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_dotgraph] "%AMENT_CURRENT_PREFIX%\share\qt_dotgraph\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_dotgraph] "%AMENT_CURRENT_PREFIX%\share\qt_dotgraph\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_dotgraph] "%AMENT_CURRENT_PREFIX%\share\qt_dotgraph\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[qt_dotgraph]:;=";"%") do (
    call:call_file %%f
  )
