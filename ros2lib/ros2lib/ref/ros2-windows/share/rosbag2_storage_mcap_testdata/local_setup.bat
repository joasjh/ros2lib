...
set "AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap_testdata]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap_testdata] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage_mcap_testdata\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap_testdata] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage_mcap_testdata\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap_testdata] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage_mcap_testdata\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap_testdata]:;=";"%") do (
    call:call_file %%f
  )
