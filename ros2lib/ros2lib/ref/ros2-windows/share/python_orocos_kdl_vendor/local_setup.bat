...
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[python_orocos_kdl_vendor] "%AMENT_CURRENT_PREFIX%\share\python_orocos_kdl_vendor\environment\pythonpath.bat"
