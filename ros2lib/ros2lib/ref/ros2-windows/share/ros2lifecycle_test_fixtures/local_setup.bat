...
set "AMENT_ENVIRONMENT_HOOKS[ros2lifecycle_test_fixtures]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2lifecycle_test_fixtures] "%AMENT_CURRENT_PREFIX%\share\ros2lifecycle_test_fixtures\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2lifecycle_test_fixtures] "%AMENT_CURRENT_PREFIX%\share\ros2lifecycle_test_fixtures\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros2lifecycle_test_fixtures]:;=";"%") do (
    call:call_file %%f
  )
