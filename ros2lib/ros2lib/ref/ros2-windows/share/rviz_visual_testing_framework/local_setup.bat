...
set "AMENT_ENVIRONMENT_HOOKS[rviz_visual_testing_framework]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_visual_testing_framework] "%AMENT_CURRENT_PREFIX%\share\rviz_visual_testing_framework\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_visual_testing_framework] "%AMENT_CURRENT_PREFIX%\share\rviz_visual_testing_framework\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rviz_visual_testing_framework]:;=";"%") do (
    call:call_file %%f
  )
