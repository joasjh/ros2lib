...
set "AMENT_ENVIRONMENT_HOOKS[image_transport]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[image_transport] "%AMENT_CURRENT_PREFIX%\share\image_transport\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[image_transport] "%AMENT_CURRENT_PREFIX%\share\image_transport\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[image_transport]:;=";"%") do (
    call:call_file %%f
  )
