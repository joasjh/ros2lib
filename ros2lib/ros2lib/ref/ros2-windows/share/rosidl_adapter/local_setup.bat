...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_adapter]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_adapter] "%AMENT_CURRENT_PREFIX%\share\rosidl_adapter\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_adapter] "%AMENT_CURRENT_PREFIX%\share\rosidl_adapter\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_adapter] "%AMENT_CURRENT_PREFIX%\share\rosidl_adapter\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_adapter]:;=";"%") do (
    call:call_file %%f
  )
