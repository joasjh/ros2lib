...
set "AMENT_ENVIRONMENT_HOOKS[keyboard_handler]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[keyboard_handler] "%AMENT_CURRENT_PREFIX%\share\keyboard_handler\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[keyboard_handler] "%AMENT_CURRENT_PREFIX%\share\keyboard_handler\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[keyboard_handler]:;=";"%") do (
    call:call_file %%f
  )
