...
set "AMENT_ENVIRONMENT_HOOKS[geometry2]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[geometry2] "%AMENT_CURRENT_PREFIX%\share\geometry2\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[geometry2] "%AMENT_CURRENT_PREFIX%\share\geometry2\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[geometry2]:;=";"%") do (
    call:call_file %%f
  )
