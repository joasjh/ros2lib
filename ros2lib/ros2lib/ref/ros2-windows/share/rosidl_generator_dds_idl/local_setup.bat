...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_generator_dds_idl]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_generator_dds_idl] "%AMENT_CURRENT_PREFIX%\share\rosidl_generator_dds_idl\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_generator_dds_idl] "%AMENT_CURRENT_PREFIX%\share\rosidl_generator_dds_idl\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_generator_dds_idl] "%AMENT_CURRENT_PREFIX%\share\rosidl_generator_dds_idl\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_generator_dds_idl]:;=";"%") do (
    call:call_file %%f
  )
