...
set "AMENT_ENVIRONMENT_HOOKS[python_qt_binding]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[python_qt_binding] "%AMENT_CURRENT_PREFIX%\share\python_qt_binding\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[python_qt_binding] "%AMENT_CURRENT_PREFIX%\share\python_qt_binding\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[python_qt_binding] "%AMENT_CURRENT_PREFIX%\share\python_qt_binding\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[python_qt_binding]:;=";"%") do (
    call:call_file %%f
  )
