...
set "AMENT_ENVIRONMENT_HOOKS[rcutils]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rcutils] "%AMENT_CURRENT_PREFIX%\share\rcutils\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rcutils] "%AMENT_CURRENT_PREFIX%\share\rcutils\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rcutils] "%AMENT_CURRENT_PREFIX%\share\rcutils\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rcutils]:;=";"%") do (
    call:call_file %%f
  )
