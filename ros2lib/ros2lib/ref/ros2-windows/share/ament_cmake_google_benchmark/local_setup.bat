...
set "AMENT_ENVIRONMENT_HOOKS[ament_cmake_google_benchmark]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_google_benchmark] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_google_benchmark\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_google_benchmark] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_google_benchmark\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_google_benchmark] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_google_benchmark\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cmake_google_benchmark]:;=";"%") do (
    call:call_file %%f
  )
