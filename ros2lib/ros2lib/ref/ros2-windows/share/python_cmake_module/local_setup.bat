...
set "AMENT_ENVIRONMENT_HOOKS[python_cmake_module]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[python_cmake_module] "%AMENT_CURRENT_PREFIX%\share\python_cmake_module\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[python_cmake_module] "%AMENT_CURRENT_PREFIX%\share\python_cmake_module\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[python_cmake_module]:;=";"%") do (
    call:call_file %%f
  )
