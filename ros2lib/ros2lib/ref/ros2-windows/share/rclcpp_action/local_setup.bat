...
set "AMENT_ENVIRONMENT_HOOKS[rclcpp_action]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rclcpp_action] "%AMENT_CURRENT_PREFIX%\share\rclcpp_action\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rclcpp_action] "%AMENT_CURRENT_PREFIX%\share\rclcpp_action\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rclcpp_action]:;=";"%") do (
    call:call_file %%f
  )
