...
set "AMENT_ENVIRONMENT_HOOKS[ament_cmake_cpplint]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_cpplint] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_cpplint\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_cpplint] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_cpplint\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cmake_cpplint]:;=";"%") do (
    call:call_file %%f
  )
