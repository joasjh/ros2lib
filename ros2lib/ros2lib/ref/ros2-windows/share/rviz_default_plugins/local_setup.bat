...
set "AMENT_ENVIRONMENT_HOOKS[rviz_default_plugins]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_default_plugins] "%AMENT_CURRENT_PREFIX%\share\rviz_default_plugins\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_default_plugins] "%AMENT_CURRENT_PREFIX%\share\rviz_default_plugins\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rviz_default_plugins]:;=";"%") do (
    call:call_file %%f
  )
