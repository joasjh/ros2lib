...
set "AMENT_ENVIRONMENT_HOOKS[message_filters]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[message_filters] "%AMENT_CURRENT_PREFIX%\share\message_filters\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[message_filters] "%AMENT_CURRENT_PREFIX%\share\message_filters\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[message_filters] "%AMENT_CURRENT_PREFIX%\share\message_filters\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[message_filters]:;=";"%") do (
    call:call_file %%f
  )
