...
set "AMENT_ENVIRONMENT_HOOKS[turtlesim]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[turtlesim] "%AMENT_CURRENT_PREFIX%\share\turtlesim\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[turtlesim] "%AMENT_CURRENT_PREFIX%\share\turtlesim\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[turtlesim] "%AMENT_CURRENT_PREFIX%\share\turtlesim\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[turtlesim]:;=";"%") do (
    call:call_file %%f
  )
