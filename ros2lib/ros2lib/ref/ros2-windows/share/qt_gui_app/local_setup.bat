...
set "AMENT_ENVIRONMENT_HOOKS[qt_gui_app]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_gui_app] "%AMENT_CURRENT_PREFIX%\share\qt_gui_app\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_gui_app] "%AMENT_CURRENT_PREFIX%\share\qt_gui_app\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[qt_gui_app]:;=";"%") do (
    call:call_file %%f
  )
