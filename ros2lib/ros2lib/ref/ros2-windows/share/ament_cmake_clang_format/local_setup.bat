...
set "AMENT_ENVIRONMENT_HOOKS[ament_cmake_clang_format]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_clang_format] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_clang_format\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_clang_format] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_clang_format\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cmake_clang_format]:;=";"%") do (
    call:call_file %%f
  )
