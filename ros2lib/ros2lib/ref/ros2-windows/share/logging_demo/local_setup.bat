...
set "AMENT_ENVIRONMENT_HOOKS[logging_demo]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[logging_demo] "%AMENT_CURRENT_PREFIX%\share\logging_demo\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[logging_demo] "%AMENT_CURRENT_PREFIX%\share\logging_demo\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[logging_demo] "%AMENT_CURRENT_PREFIX%\share\logging_demo\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[logging_demo]:;=";"%") do (
    call:call_file %%f
  )
