...
set "AMENT_ENVIRONMENT_HOOKS[intra_process_demo]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[intra_process_demo] "%AMENT_CURRENT_PREFIX%\share\intra_process_demo\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[intra_process_demo] "%AMENT_CURRENT_PREFIX%\share\intra_process_demo\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[intra_process_demo]:;=";"%") do (
    call:call_file %%f
  )
