...
set "AMENT_ENVIRONMENT_HOOKS[rclcpp]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rclcpp] "%AMENT_CURRENT_PREFIX%\share\rclcpp\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rclcpp] "%AMENT_CURRENT_PREFIX%\share\rclcpp\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rclcpp]:;=";"%") do (
    call:call_file %%f
  )
