...
set "AMENT_ENVIRONMENT_HOOKS[urdf_parser_plugin]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[urdf_parser_plugin] "%AMENT_CURRENT_PREFIX%\share\urdf_parser_plugin\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[urdf_parser_plugin] "%AMENT_CURRENT_PREFIX%\share\urdf_parser_plugin\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[urdf_parser_plugin]:;=";"%") do (
    call:call_file %%f
  )
