...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\nav_msgs\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\nav_msgs\hook\path_dll.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\nav_msgs\hook\path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\nav_msgs\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\nav_msgs\hook\pythonscriptspath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/nav_msgs/local_setup.bat"
