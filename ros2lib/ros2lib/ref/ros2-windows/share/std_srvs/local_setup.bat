...
set "AMENT_ENVIRONMENT_HOOKS[std_srvs]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[std_srvs] "%AMENT_CURRENT_PREFIX%\share\std_srvs\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[std_srvs] "%AMENT_CURRENT_PREFIX%\share\std_srvs\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[std_srvs] "%AMENT_CURRENT_PREFIX%\share\std_srvs\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[std_srvs]:;=";"%") do (
    call:call_file %%f
  )
