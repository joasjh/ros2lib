...
set "AMENT_ENVIRONMENT_HOOKS[rosbag2_cpp]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_cpp] "%AMENT_CURRENT_PREFIX%\share\rosbag2_cpp\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_cpp] "%AMENT_CURRENT_PREFIX%\share\rosbag2_cpp\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosbag2_cpp]:;=";"%") do (
    call:call_file %%f
  )
