...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_generator_py]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_generator_py] "%AMENT_CURRENT_PREFIX%\share\rosidl_generator_py\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_generator_py] "%AMENT_CURRENT_PREFIX%\share\rosidl_generator_py\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_generator_py] "%AMENT_CURRENT_PREFIX%\share\rosidl_generator_py\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_generator_py]:;=";"%") do (
    call:call_file %%f
  )
