...
set "AMENT_ENVIRONMENT_HOOKS[camera_calibration_parsers]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[camera_calibration_parsers] "%AMENT_CURRENT_PREFIX%\share\camera_calibration_parsers\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[camera_calibration_parsers] "%AMENT_CURRENT_PREFIX%\share\camera_calibration_parsers\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[camera_calibration_parsers]:;=";"%") do (
    call:call_file %%f
  )
