...
set "AMENT_ENVIRONMENT_HOOKS[ament_cmake_gtest]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_gtest] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_gtest\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_gtest] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_gtest\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cmake_gtest]:;=";"%") do (
    call:call_file %%f
  )
