...
set "AMENT_ENVIRONMENT_HOOKS[diagnostic_msgs]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[diagnostic_msgs] "%AMENT_CURRENT_PREFIX%\share\diagnostic_msgs\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[diagnostic_msgs] "%AMENT_CURRENT_PREFIX%\share\diagnostic_msgs\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[diagnostic_msgs] "%AMENT_CURRENT_PREFIX%\share\diagnostic_msgs\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[diagnostic_msgs]:;=";"%") do (
    call:call_file %%f
  )
