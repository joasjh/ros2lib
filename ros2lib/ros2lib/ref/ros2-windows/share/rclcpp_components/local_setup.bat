...
set "AMENT_ENVIRONMENT_HOOKS[rclcpp_components]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rclcpp_components] "%AMENT_CURRENT_PREFIX%\share\rclcpp_components\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rclcpp_components] "%AMENT_CURRENT_PREFIX%\share\rclcpp_components\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rclcpp_components]:;=";"%") do (
    call:call_file %%f
  )
