...
set "AMENT_ENVIRONMENT_HOOKS[dummy_map_server]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[dummy_map_server] "%AMENT_CURRENT_PREFIX%\share\dummy_map_server\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[dummy_map_server] "%AMENT_CURRENT_PREFIX%\share\dummy_map_server\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[dummy_map_server]:;=";"%") do (
    call:call_file %%f
  )
