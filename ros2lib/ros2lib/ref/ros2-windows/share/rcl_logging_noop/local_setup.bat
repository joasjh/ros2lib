...
set "AMENT_ENVIRONMENT_HOOKS[rcl_logging_noop]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rcl_logging_noop] "%AMENT_CURRENT_PREFIX%\share\rcl_logging_noop\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rcl_logging_noop] "%AMENT_CURRENT_PREFIX%\share\rcl_logging_noop\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rcl_logging_noop]:;=";"%") do (
    call:call_file %%f
  )
