...
set "AMENT_ENVIRONMENT_HOOKS[visualization_msgs]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[visualization_msgs] "%AMENT_CURRENT_PREFIX%\share\visualization_msgs\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[visualization_msgs] "%AMENT_CURRENT_PREFIX%\share\visualization_msgs\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[visualization_msgs] "%AMENT_CURRENT_PREFIX%\share\visualization_msgs\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[visualization_msgs]:;=";"%") do (
    call:call_file %%f
  )
