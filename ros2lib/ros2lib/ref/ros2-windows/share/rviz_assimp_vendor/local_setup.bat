...
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_assimp_vendor] "%AMENT_CURRENT_PREFIX%\share\rviz_assimp_vendor\environment\rviz_assimp_vendor_library_path.bat"
