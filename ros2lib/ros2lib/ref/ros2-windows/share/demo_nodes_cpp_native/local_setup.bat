...
set "AMENT_ENVIRONMENT_HOOKS[demo_nodes_cpp_native]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[demo_nodes_cpp_native] "%AMENT_CURRENT_PREFIX%\share\demo_nodes_cpp_native\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[demo_nodes_cpp_native] "%AMENT_CURRENT_PREFIX%\share\demo_nodes_cpp_native\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[demo_nodes_cpp_native]:;=";"%") do (
    call:call_file %%f
  )
