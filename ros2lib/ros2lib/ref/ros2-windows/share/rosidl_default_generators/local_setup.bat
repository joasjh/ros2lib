...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_default_generators]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_default_generators] "%AMENT_CURRENT_PREFIX%\share\rosidl_default_generators\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_default_generators] "%AMENT_CURRENT_PREFIX%\share\rosidl_default_generators\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_default_generators]:;=";"%") do (
    call:call_file %%f
  )
