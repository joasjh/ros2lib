...
foreach(_cmake_expected_target IN ITEMS tf2::tf2)
...
# Create imported target tf2::tf2
add_library(tf2::tf2 SHARED IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/export_tf2Export-*.cmake")
