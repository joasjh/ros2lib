...
set "AMENT_ENVIRONMENT_HOOKS[launch_testing_ament_cmake]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[launch_testing_ament_cmake] "%AMENT_CURRENT_PREFIX%\share\launch_testing_ament_cmake\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[launch_testing_ament_cmake] "%AMENT_CURRENT_PREFIX%\share\launch_testing_ament_cmake\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[launch_testing_ament_cmake]:;=";"%") do (
    call:call_file %%f
  )
