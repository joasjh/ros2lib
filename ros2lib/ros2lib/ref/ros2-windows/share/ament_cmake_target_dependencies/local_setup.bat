...
set "AMENT_ENVIRONMENT_HOOKS[ament_cmake_target_dependencies]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_target_dependencies] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_target_dependencies\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_target_dependencies] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_target_dependencies\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cmake_target_dependencies]:;=";"%") do (
    call:call_file %%f
  )
