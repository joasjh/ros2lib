...
set "AMENT_ENVIRONMENT_HOOKS[laser_geometry]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[laser_geometry] "%AMENT_CURRENT_PREFIX%\share\laser_geometry\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[laser_geometry] "%AMENT_CURRENT_PREFIX%\share\laser_geometry\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[laser_geometry] "%AMENT_CURRENT_PREFIX%\share\laser_geometry\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[laser_geometry]:;=";"%") do (
    call:call_file %%f
  )
