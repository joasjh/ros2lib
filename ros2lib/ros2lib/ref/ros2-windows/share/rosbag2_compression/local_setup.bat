...
set "AMENT_ENVIRONMENT_HOOKS[rosbag2_compression]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_compression] "%AMENT_CURRENT_PREFIX%\share\rosbag2_compression\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_compression] "%AMENT_CURRENT_PREFIX%\share\rosbag2_compression\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosbag2_compression]:;=";"%") do (
    call:call_file %%f
  )
