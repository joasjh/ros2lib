...
set "AMENT_ENVIRONMENT_HOOKS[quality_of_service_demo_cpp]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[quality_of_service_demo_cpp] "%AMENT_CURRENT_PREFIX%\share\quality_of_service_demo_cpp\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[quality_of_service_demo_cpp] "%AMENT_CURRENT_PREFIX%\share\quality_of_service_demo_cpp\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[quality_of_service_demo_cpp]:;=";"%") do (
    call:call_file %%f
  )
