...
set "AMENT_ENVIRONMENT_HOOKS[pluginlib]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[pluginlib] "%AMENT_CURRENT_PREFIX%\share\pluginlib\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[pluginlib] "%AMENT_CURRENT_PREFIX%\share\pluginlib\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[pluginlib]:;=";"%") do (
    call:call_file %%f
  )
