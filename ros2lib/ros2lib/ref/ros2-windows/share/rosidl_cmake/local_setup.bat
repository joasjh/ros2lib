...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_cmake]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_cmake] "%AMENT_CURRENT_PREFIX%\share\rosidl_cmake\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_cmake] "%AMENT_CURRENT_PREFIX%\share\rosidl_cmake\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_cmake] "%AMENT_CURRENT_PREFIX%\share\rosidl_cmake\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_cmake]:;=";"%") do (
    call:call_file %%f
  )
