...
set "AMENT_ENVIRONMENT_HOOKS[libstatistics_collector]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[libstatistics_collector] "%AMENT_CURRENT_PREFIX%\share\libstatistics_collector\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[libstatistics_collector] "%AMENT_CURRENT_PREFIX%\share\libstatistics_collector\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[libstatistics_collector]:;=";"%") do (
    call:call_file %%f
  )
