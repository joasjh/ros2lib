...
set "AMENT_ENVIRONMENT_HOOKS[rmw_connextdds]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rmw_connextdds] "%AMENT_CURRENT_PREFIX%\share\rmw_connextdds\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rmw_connextdds] "%AMENT_CURRENT_PREFIX%\share\rmw_connextdds\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rmw_connextdds]:;=";"%") do (
    call:call_file %%f
  )
