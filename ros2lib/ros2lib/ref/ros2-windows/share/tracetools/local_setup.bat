...
set "AMENT_ENVIRONMENT_HOOKS[tracetools]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[tracetools] "%AMENT_CURRENT_PREFIX%\share\tracetools\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[tracetools] "%AMENT_CURRENT_PREFIX%\share\tracetools\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[tracetools]:;=";"%") do (
    call:call_file %%f
  )
