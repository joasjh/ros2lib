...
set "AMENT_ENVIRONMENT_HOOKS[camera_info_manager]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[camera_info_manager] "%AMENT_CURRENT_PREFIX%\share\camera_info_manager\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[camera_info_manager] "%AMENT_CURRENT_PREFIX%\share\camera_info_manager\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[camera_info_manager]:;=";"%") do (
    call:call_file %%f
  )
