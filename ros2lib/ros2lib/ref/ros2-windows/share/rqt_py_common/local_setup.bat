...
set "AMENT_ENVIRONMENT_HOOKS[rqt_py_common]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_py_common] "%AMENT_CURRENT_PREFIX%\share\rqt_py_common\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_py_common] "%AMENT_CURRENT_PREFIX%\share\rqt_py_common\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_py_common] "%AMENT_CURRENT_PREFIX%\share\rqt_py_common\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rqt_py_common]:;=";"%") do (
    call:call_file %%f
  )
