...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_client\hook\path_dll.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_client\hook\path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_client\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_client\hook\pythonscriptspath.bat"
