...
set "AMENT_ENVIRONMENT_HOOKS[ament_cmake_clang_tidy]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_clang_tidy] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_clang_tidy\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_clang_tidy] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_clang_tidy\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cmake_clang_tidy]:;=";"%") do (
    call:call_file %%f
  )
