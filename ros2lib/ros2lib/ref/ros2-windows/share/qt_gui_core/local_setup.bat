...
set "AMENT_ENVIRONMENT_HOOKS[qt_gui_core]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_gui_core] "%AMENT_CURRENT_PREFIX%\share\qt_gui_core\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_gui_core] "%AMENT_CURRENT_PREFIX%\share\qt_gui_core\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[qt_gui_core]:;=";"%") do (
    call:call_file %%f
  )
