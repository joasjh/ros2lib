...
set "AMENT_ENVIRONMENT_HOOKS[rosbag2]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2] "%AMENT_CURRENT_PREFIX%\share\rosbag2\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2] "%AMENT_CURRENT_PREFIX%\share\rosbag2\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosbag2]:;=";"%") do (
    call:call_file %%f
  )
