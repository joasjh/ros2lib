...
set "AMENT_ENVIRONMENT_HOOKS[rmw_connextddsmicro]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rmw_connextddsmicro] "%AMENT_CURRENT_PREFIX%\share\rmw_connextddsmicro\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rmw_connextddsmicro] "%AMENT_CURRENT_PREFIX%\share\rmw_connextddsmicro\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rmw_connextddsmicro]:;=";"%") do (
    call:call_file %%f
  )
