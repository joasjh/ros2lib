...
set "AMENT_ENVIRONMENT_HOOKS[tf2_ros]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[tf2_ros] "%AMENT_CURRENT_PREFIX%\share\tf2_ros\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[tf2_ros] "%AMENT_CURRENT_PREFIX%\share\tf2_ros\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[tf2_ros]:;=";"%") do (
    call:call_file %%f
  )
