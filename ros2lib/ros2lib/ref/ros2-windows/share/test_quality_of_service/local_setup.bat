...
set "AMENT_ENVIRONMENT_HOOKS[test_quality_of_service]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[test_quality_of_service] "%AMENT_CURRENT_PREFIX%\share\test_quality_of_service\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[test_quality_of_service] "%AMENT_CURRENT_PREFIX%\share\test_quality_of_service\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[test_quality_of_service]:;=";"%") do (
    call:call_file %%f
  )
