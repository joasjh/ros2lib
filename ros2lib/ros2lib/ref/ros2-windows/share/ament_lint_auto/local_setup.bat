...
set "AMENT_ENVIRONMENT_HOOKS[ament_lint_auto]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_lint_auto] "%AMENT_CURRENT_PREFIX%\share\ament_lint_auto\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_lint_auto] "%AMENT_CURRENT_PREFIX%\share\ament_lint_auto\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_lint_auto]:;=";"%") do (
    call:call_file %%f
  )
