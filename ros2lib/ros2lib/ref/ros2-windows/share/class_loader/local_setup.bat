...
set "AMENT_ENVIRONMENT_HOOKS[class_loader]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[class_loader] "%AMENT_CURRENT_PREFIX%\share\class_loader\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[class_loader] "%AMENT_CURRENT_PREFIX%\share\class_loader\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[class_loader]:;=";"%") do (
    call:call_file %%f
  )
