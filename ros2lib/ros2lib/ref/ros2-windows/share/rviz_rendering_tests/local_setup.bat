...
set "AMENT_ENVIRONMENT_HOOKS[rviz_rendering_tests]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_rendering_tests] "%AMENT_CURRENT_PREFIX%\share\rviz_rendering_tests\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_rendering_tests] "%AMENT_CURRENT_PREFIX%\share\rviz_rendering_tests\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rviz_rendering_tests]:;=";"%") do (
    call:call_file %%f
  )
