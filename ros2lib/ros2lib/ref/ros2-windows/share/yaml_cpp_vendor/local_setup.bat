...
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[yaml_cpp_vendor] "%AMENT_CURRENT_PREFIX%\share\yaml_cpp_vendor\environment\yaml_cpp_vendor_library_path.bat"
