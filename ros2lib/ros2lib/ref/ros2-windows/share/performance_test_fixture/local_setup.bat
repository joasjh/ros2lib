...
set "AMENT_ENVIRONMENT_HOOKS[performance_test_fixture]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[performance_test_fixture] "%AMENT_CURRENT_PREFIX%\share\performance_test_fixture\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[performance_test_fixture] "%AMENT_CURRENT_PREFIX%\share\performance_test_fixture\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[performance_test_fixture]:;=";"%") do (
    call:call_file %%f
  )
