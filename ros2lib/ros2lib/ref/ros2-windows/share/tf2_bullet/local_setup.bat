...
set "AMENT_ENVIRONMENT_HOOKS[tf2_bullet]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[tf2_bullet] "%AMENT_CURRENT_PREFIX%\share\tf2_bullet\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[tf2_bullet] "%AMENT_CURRENT_PREFIX%\share\tf2_bullet\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[tf2_bullet]:;=";"%") do (
    call:call_file %%f
  )
