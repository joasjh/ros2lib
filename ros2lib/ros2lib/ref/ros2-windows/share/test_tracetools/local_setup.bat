...
set "AMENT_ENVIRONMENT_HOOKS[test_tracetools]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[test_tracetools] "%AMENT_CURRENT_PREFIX%\share\test_tracetools\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[test_tracetools] "%AMENT_CURRENT_PREFIX%\share\test_tracetools\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[test_tracetools]:;=";"%") do (
    call:call_file %%f
  )
