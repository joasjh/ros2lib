...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_default_runtime]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_default_runtime] "%AMENT_CURRENT_PREFIX%\share\rosidl_default_runtime\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_default_runtime] "%AMENT_CURRENT_PREFIX%\share\rosidl_default_runtime\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_default_runtime]:;=";"%") do (
    call:call_file %%f
  )
