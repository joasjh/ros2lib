...
set "AMENT_ENVIRONMENT_HOOKS[robot_state_publisher]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[robot_state_publisher] "%AMENT_CURRENT_PREFIX%\share\robot_state_publisher\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[robot_state_publisher] "%AMENT_CURRENT_PREFIX%\share\robot_state_publisher\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[robot_state_publisher]:;=";"%") do (
    call:call_file %%f
  )
