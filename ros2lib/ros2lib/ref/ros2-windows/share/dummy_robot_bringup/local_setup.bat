...
set "AMENT_ENVIRONMENT_HOOKS[dummy_robot_bringup]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[dummy_robot_bringup] "%AMENT_CURRENT_PREFIX%\share\dummy_robot_bringup\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[dummy_robot_bringup] "%AMENT_CURRENT_PREFIX%\share\dummy_robot_bringup\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[dummy_robot_bringup]:;=";"%") do (
    call:call_file %%f
  )
