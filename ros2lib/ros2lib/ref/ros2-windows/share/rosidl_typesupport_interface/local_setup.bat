...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_interface]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_interface] "%AMENT_CURRENT_PREFIX%\share\rosidl_typesupport_interface\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_interface] "%AMENT_CURRENT_PREFIX%\share\rosidl_typesupport_interface\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_interface]:;=";"%") do (
    call:call_file %%f
  )
