...
set "AMENT_ENVIRONMENT_HOOKS[interactive_markers]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[interactive_markers] "%AMENT_CURRENT_PREFIX%\share\interactive_markers\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[interactive_markers] "%AMENT_CURRENT_PREFIX%\share\interactive_markers\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[interactive_markers] "%AMENT_CURRENT_PREFIX%\share\interactive_markers\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[interactive_markers]:;=";"%") do (
    call:call_file %%f
  )
