...
set "AMENT_ENVIRONMENT_HOOKS[ros2cli_common_extensions]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2cli_common_extensions] "%AMENT_CURRENT_PREFIX%\share\ros2cli_common_extensions\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2cli_common_extensions] "%AMENT_CURRENT_PREFIX%\share\ros2cli_common_extensions\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros2cli_common_extensions]:;=";"%") do (
    call:call_file %%f
  )
