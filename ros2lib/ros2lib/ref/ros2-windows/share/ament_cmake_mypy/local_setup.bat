...
set "AMENT_ENVIRONMENT_HOOKS[ament_cmake_mypy]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_mypy] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_mypy\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_mypy] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_mypy\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cmake_mypy]:;=";"%") do (
    call:call_file %%f
  )
