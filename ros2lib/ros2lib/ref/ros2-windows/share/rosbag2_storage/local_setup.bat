...
set "AMENT_ENVIRONMENT_HOOKS[rosbag2_storage]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosbag2_storage]:;=";"%") do (
    call:call_file %%f
  )
