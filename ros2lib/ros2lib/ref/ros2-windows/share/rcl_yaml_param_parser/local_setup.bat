...
set "AMENT_ENVIRONMENT_HOOKS[rcl_yaml_param_parser]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rcl_yaml_param_parser] "%AMENT_CURRENT_PREFIX%\share\rcl_yaml_param_parser\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rcl_yaml_param_parser] "%AMENT_CURRENT_PREFIX%\share\rcl_yaml_param_parser\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rcl_yaml_param_parser]:;=";"%") do (
    call:call_file %%f
  )
