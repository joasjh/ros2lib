...
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_ogre_vendor] "%AMENT_CURRENT_PREFIX%\share\rviz_ogre_vendor\environment\rviz_ogre_vendor_library_path.bat"
