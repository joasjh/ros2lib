...
set "AMENT_ENVIRONMENT_HOOKS[test_rmw_implementation]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[test_rmw_implementation] "%AMENT_CURRENT_PREFIX%\share\test_rmw_implementation\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[test_rmw_implementation] "%AMENT_CURRENT_PREFIX%\share\test_rmw_implementation\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[test_rmw_implementation]:;=";"%") do (
    call:call_file %%f
  )
