...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_c]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_c] "%AMENT_CURRENT_PREFIX%\share\rosidl_typesupport_c\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_c] "%AMENT_CURRENT_PREFIX%\share\rosidl_typesupport_c\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_c] "%AMENT_CURRENT_PREFIX%\share\rosidl_typesupport_c\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_c]:;=";"%") do (
    call:call_file %%f
  )
