...
set "AMENT_ENVIRONMENT_HOOKS[qt_gui]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_gui] "%AMENT_CURRENT_PREFIX%\share\qt_gui\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_gui] "%AMENT_CURRENT_PREFIX%\share\qt_gui\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qt_gui] "%AMENT_CURRENT_PREFIX%\share\qt_gui\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[qt_gui]:;=";"%") do (
    call:call_file %%f
  )
