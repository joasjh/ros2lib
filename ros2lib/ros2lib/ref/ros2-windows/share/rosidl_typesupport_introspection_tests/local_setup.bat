...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_introspection_tests]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_introspection_tests] "%AMENT_CURRENT_PREFIX%\share\rosidl_typesupport_introspection_tests\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_introspection_tests] "%AMENT_CURRENT_PREFIX%\share\rosidl_typesupport_introspection_tests\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_introspection_tests]:;=";"%") do (
    call:call_file %%f
  )
